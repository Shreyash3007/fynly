  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(getCategoryLabel(score), 50, 330, { align: 'center' })
      ...
      // Breakdown Section
      doc.fontSize(20).fillColor('#111827').text('Score Breakdown', 50, 150)
      ...
      doc.fontSize(20).fillColor('#111827').text('Top Recommendations', 50, 50)
      ...
      if (strengths.length > 0) {
        ...
        strengths.forEach((strength, index) => {
          doc
            ...
            .fillColor('#374151')
            .text(
              `${index + 1}. ${strength.label} (${strength.score.toFixed(1)})`,
              70,
              strengthsY
            )
          strengthsY += 20
      ...
      if (risks.length > 0) {
        ...
        risks.forEach((risk, index) => {
          doc
            ...
            .fillColor('#374151')
            .text(
              `${index + 1}. ${risk.label} (${risk.score.toFixed(1)})`,
              70,
              risksYPos
            )
          risksYPos += 20
      ...
      doc
        .fontSize(10)
        .fillColor('#9CA3AF')
        .text('Generated by Fynly MVP v1.0', 50, doc.page.height - 50, {
          align: 'center',
        })
