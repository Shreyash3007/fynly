                  ...
                  <div className="space-y-4">
                    {data.upcomingBookings.map((booking: any) => (
                      ...
                      >
                        ...
                        <Link href={`/demo-call/${booking.id}`}>
                  ...
                  <div className="space-y-4">
                    {data.news.map((article: any) => (
                      <Link
                        key={article.id}
                        href="#"
                        className="flex items-start gap-4 p-4 rounded-lg hover:bg-graphite-50 transition-colors"
                      >
                ...
                <CardBody>
                  <div className="space-y-4">
                    {data.successStories.map((story: any) => (
                      <div key={story.id} className="border-b border-graphite-200 pb-4 last:border-0">
